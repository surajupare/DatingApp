...
export class PhotoEditorComponent implements OnInit {
  ...
  initilizeuploader() {
    ...
    // To immediatly show photo on screen.
  ...
  setMainPhoto(photo: Photo) {
    this.userService.setMainPhoto(this.authService.decodedToken.nameid, photo.id).subscribe(() => {
      // This functionality is for: if you click on Set to Main button on photo then that main button
      // needs to be disable and active and previously main button needs to be secoundary and main will be active
